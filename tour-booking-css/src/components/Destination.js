        ...
        <div className="destination">
            ...
            <DestinationData
                ...
                text="One of the most iconic views in Luzon, Mt. Taal boasts a volcano inside a lake inside an island.
                        If you fancy a closer look, the hike up to the crater is a mere 45 minutes, and is easy enough
                        for beginners. Guides will assist you most of the way, and you'll see the peculiar environment
                        found on an active volcano, including volcanic rocks and steam vents. The hike can be dusty and
                        hot, so plan for an early morning trip, and then unwind with some bulalo before heading back
                        home!"
                img1={Mountain1}
                img2={Mountain2}
            />
            <DestinationData
                ...
                text="If you're looking for a hike that's a little more challenging
                        ...
                        best view, the breeze is fantastic. Once you veTech? etct
                        back down, head straight to the beach for a
                        well-deserved swim."
                img1={Mountain3}
                img2={Mountain4}
            />
